...
from retail.views import ChainCreateAPIView, ChainListAPIView, ChainRetrieveAPIView, ContactsViewSet, ProductsViewSet, \
    ChainUpdateAPIView, ChainDeleteAPIView
...
] + contactRouter.urls + productRouter.urls
